              ...
              <div class="top-end">
                ...
                <c:if test="${empty sessionScope.loginMember }">
                  ...
                  <ul class="user-login">
                    ...
                    <li>
                      <a
                        href="${pageContext.request.contextPath}/member/viewSignUp"
                        >회원가입</a
                      >
                    </li>
                  </ul>
                ...
                <c:if test="${not empty sessionScope.loginMember }">
                  ...
                  <ul class="user-login">
                    <li>
                      <a
                        href="${pageContext.request.contextPath}/member/myPage/modiInfo"
                        >내 정보</a
                      >
                    </li>
                    <li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-3 col-md-3 col-7">
              ...
              >
                <img
                  src="/resources/assets/user/images/logo/logo.svg"
                  alt="Logo"
                />
              </a>
              <!-- End Header Logo -->
