						...
						<div class="col-lg-8 col-md-8 col-12">
							<div class="form-input form">
				                <div class="row addressSearchArea">
				                    <input class="postNumber col-md-8 col-lg-8 col-12" type="text" id="postcodeNew" placeholder="우편번호">
				                ...
				                <input type="text" class="col-md-10 col-lg-10 col-12" id="addressNew" placeholder="주소"><br>
