					...
					<form class="card login-form" action="/member/login" method="post">
						<div class="card-body">
							...
							<div class="form-group input-group">
								<label for="reg-fn">ID</label> <input class="form-control"
									type="text" name="member_id" id="member_id" required> <span></span>
								<input type="hidden">
							</div>
							<div class="form-group input-group">
							...
							<div class="button">
								<button class="btn" type="button" id="sendMailBtn"
...
<script type="text/javascript">
	...
	function sendMail(email, member_id) {
		$.ajax({
			url : "/member/find/pwd",
			type : "GET",
			data : {
			...
			success : function(data) {
				...
				} else if(data.status=="fail" && data.value=="아이디 또는 이메일 에러") {
					isMsg("email", "아이디 또는 이메일이 잘못됬습니다..", "red", false);
