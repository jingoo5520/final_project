...
<body>
	<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
		...
		<ul class="menu-inner py-1">
			<!-- Dashboard -->
			<li class="menu-item <%="dashboard".equals(request.getParameter("pageName")) ? "active" : ""%>">
			...
			<li class="menu-item <%="adminmemberview".equals(request.getParameter("pageName")) || "adminmemberlevel".equals(request.getParameter("pageName"))
				? "active open"
				: ""%>">
				...
				<ul class="menu-sub">
					<li class="menu-item <%="adminmemberview".equals(request.getParameter("pageName")) ? "active" : ""%>">
						<a href="/admin/memberView" class="menu-link">
			...
			<li class="menu-item <%="productSave".equals(request.getParameter("pageName")) || "productView".equals(request.getParameter("pageName"))
				...
				<ul class="menu-sub">
					<li class="menu-item <%="productSave".equals(request.getParameter("pageName")) ? "active" : ""%>">
						<a href="/admin/productmanage/productSave" class="menu-link">
							<div data-i18n="productSave">상품</div>
						</a>
					</li>
					<li class="menu-item  <%="productView".equals(request.getParameter("pageName")) ? "active" : ""%>">
						<a href="/admin/productmanage/productView " class="menu-link">
		...
		|| "couponPay".equals(request.getParameter("pageName")) ? "active open" : ""%>">
				<a href="javascript:void(0);" class="menu-link menu-toggle">
					<i class="menu-icon tf-icons bx bx-dock-top"></i>
				...
				<ul class="menu-sub">
					...
					<li class="menu-item <%="coupons".equals(request.getParameter("pageName")) ? "active" : ""%>">
						<a href="/admin/coupon/coupons" class="menu-link">
							<div data-i18n="Coupons">쿠폰</div>
						</a>
					</li>
					<li class="menu-item <%="couponPay".equals(request.getParameter("pageName")) ? "active" : ""%>">
						<a href="/admin/coupon/couponPay" class="menu-link">
							<div data-i18n="Coupon Pay">쿠폰 지급</div>
						</a>
					</li>
					<li class="menu-item <%="couponUseLog".equals(request.getParameter("pageName")) ? "active" : ""%>">
						<a href="/admin/coupon/couponUseLog" class="menu-link">
		...
		: ""%>"><a href="javascript:void(0);" class="menu-link menu-toggle"> <i class="menu-icon tf-icons bx bx-dock-top"></i>
			...
			<li class="menu-item <%="adminInquiries".equals(request.getParameter("pageName")) || "reports".equals(request.getParameter("pageName"))
				? "active open"
				: ""%>"><a href="javascript:void(0);" class="menu-link menu-toggle"> <i class="menu-icon tf-icons bx bx-dock-top"></i>
