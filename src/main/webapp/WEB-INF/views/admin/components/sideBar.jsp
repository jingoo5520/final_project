...
<body>
	<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
		<div class="app-brand demo">
			<a href="/controller/admin" class="app-brand-link"> <span class="app-brand-logo demo">
		...
		<ul class="menu-inner py-1">
			<!-- Dashboard -->
			<li class="menu-item <%= "dashboard".equals(request.getParameter("pageName")) ? "active" : "" %>"><a href="/controller/admin" class="menu-link"> <i class="menu-icon tf-icons bx bx-home-circle"></i>
			...
			<li class="menu-item <%= "coupons".equals(request.getParameter("pageName")) || "couponUseLog".equals(request.getParameter("pageName")) ? "active open" : "" %>"><a href="javascript:void(0);" class="menu-link menu-toggle"> <i class="menu-icon tf-icons bx bx-dock-top"></i>
				...
				<ul class="menu-sub">
					<li class="menu-item <%= "coupons".equals(request.getParameter("pageName")) ? "active" : "" %>"><a href="/controller/admin/coupons" class="menu-link">
							<div data-i18n="Coupons">쿠폰</div>
					</a></li>
					<li class="menu-item <%= "couponUseLog".equals(request.getParameter("pageName")) ? "active" : "" %>"><a href="/controller/admin/couponUseLog" class="menu-link">
