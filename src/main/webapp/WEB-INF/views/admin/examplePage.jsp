		...
		<div class="layout-container">
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item open active"><a href="javascript:void(0);" class="menu-link menu-toggle"> <i class="menu-icon tf-icons bx bx-dock-top"></i>
						...
						<ul class="menu-sub">
							...
							<li class="menu-item"><a href="/admin/couponUseLog" class="menu-link">
					...
					<li class="menu-item"><a href="javascript:void(0);" class="menu-link menu-toggle"> <i class="menu-icon tf-icons bx bx-dock-top"></i>
						...
						<ul class="menu-sub">
							<li class="menu-item"><a href="/admin/notice" class="menu-link">
									<div data-i18n="notices">공지</div>
							</a></li>
							<li class="menu-item"><a href="/admin/event" class="menu-link">
