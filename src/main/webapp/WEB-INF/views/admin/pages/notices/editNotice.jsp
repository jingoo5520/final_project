	...
	<div class="layout-wrapper layout-content-navbar">
		<div class="layout-container">
			...
			<jsp:include page="/WEB-INF/views/admin/components/sideBar.jsp">
				...
				<jsp:param name="editNotice" value="editNotice" />
        ...
        <!-- Layout container -->
			...
			<div class="layout-page">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">공지 /</span> 공지사항 수정</h4>
	                ...
	                <div class="col-12">
		                <div class="card mb-4">
			                <div class="card-body demo-vertical-spacing demo-only-element">
				                <form action="/admin/notices/updateNotice" method="post">
					                <input type="hidden" name="notice_no" value="${notice.notice_no}" />
						                ...
						                <a href="/admin/notices/notice" class="btn rounded-pill btn-outline-secondary">취소</a>
					            	</div>
					        	</form>
				        	</div>
			        	</div>
