	...
	<div class="layout-wrapper layout-content-navbar">
        ...
        <!-- Layout container -->
			...
			<div class="layout-page">
               ...
               <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">공지 /</span>이벤트 작성</h4>
                ...
                <div class="col-12">
                  <div class="card mb-4">
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      ...
                      <form id="eventForm" action="/admin/notices/addEvent" method="post" enctype="multipart/form-data">
...
<!-- 					<label for="bannerImage">배너 이미지 업로드:</label> -->
...
<!-- 					<label for="thumbnailImage">썸네일 이미지 업로드:</label> -->
...
<!-- 					<button id="uploadButton">저장</button> -->
				...
				<!-- 이벤트 등록 버튼 -->
		      	<div class="text-end mt-3">
					<button type="submit" class="btn rounded-pill btn-outline-primary">이벤트 등록</button>
				</div>
                </form>
                </div>
                    </div>
