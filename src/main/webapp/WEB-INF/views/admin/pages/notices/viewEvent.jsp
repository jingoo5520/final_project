                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <!-- 썸네일 이미지 표시 -->
								<c:if test="${not empty event.thumbnail_image}">
								    <img src="${pageContext.request.contextPath}${event.thumbnail_image}" alt="썸네일 이미지" style="width: 100%; height: auto; max-width: 300px;" />
								</c:if>
                                <c:if test="${empty event.thumbnail_image}">
                                    <p>썸네일 이미지가 없습니다.</p>
                                </c:if>
                            </div>
