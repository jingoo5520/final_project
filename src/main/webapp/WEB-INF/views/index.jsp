			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner"
						style="background-image: url('/resources/assets/user/images/banner/banner-1-bg.jpg')">
						<div class="content">
						...
						<div class="col-lg-4 col-12">
							<div class="payment-gateway">
								<span>We Accept:</span> <img
									src="/resources/assets/user/images/footer/credit-cards-footer.png"
									alt="#">
							</div>
						</div>
						<div class="col-lg-4 col-12">
