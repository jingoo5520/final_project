...
public class PagingInfo {
    ...
    private int pageSize; // 한 페이지당 보여줄 게시물 수 (기존: viewPostCntPerPage)
    ...
    private int pageBlockSize = 10; // 한 페이지 블록에 보여줄 페이지 수 (예: 10페이지씩)
    ...
    private int endPage; // 현재 블록의 끝 페이지 번호 (기존: endPageNoCurBlock)
