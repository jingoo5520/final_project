...
public class PController {
	...
	public String showProductList(HttpServletRequest request,
			...
			@RequestParam(value = "pageSize", defaultValue = "6") int pageSize, // 占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙품
																				// 占쏙옙占쏙옙
		...
		if (loginDTO != null) {
			...
			model.addAttribute("wishList", new int[0]);
		}
	...
	public String search(@RequestParam(required = false) String search, // 占싯삼옙占쏙옙
			@RequestParam(required = false) Integer category, // 카占쌓곤옙占쏙옙 (占쏙옙占쏙옙)
			@RequestParam(defaultValue = "1") int page, // 占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙호
			@RequestParam(value = "sortOrder", defaultValue = "new") String sortOrder, Model model) throws Exception {

		System.out.println("占싯삼옙占싯삼옙 : search=" + search + ", category=" + category + ", page=" + page + ", sortOrder="
				+ sortOrder);
